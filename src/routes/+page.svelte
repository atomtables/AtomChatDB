...
<div class="flex flex-row space-x-2">
    <div class="bg-neutral-800/10 p-2 my-2 flex flex-row items-end space-x-1 h-14 backdrop-blur-3xl">
        <input type="text" placeholder="domain" class="x1" oninput={resizeInput} tabindex="0" size="8">
        <div class="-mb-1.75">
            .
        </div>
        <input type="text" placeholder="class" class="x1" oninput={resizeInput} tabindex="0" size="8">
        <div class="-mb-1.75">
            .
        </div>
        <input type="text" placeholder="focus" class="x1" oninput={resizeInput} tabindex="0" size="8">
        <div class="-mb-1.75">
            .
        </div>
        <input type="text" placeholder="topic" class="x1" oninput={resizeInput} tabindex="0" size="8">
    </div>
